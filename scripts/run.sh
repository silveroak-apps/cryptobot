...
if [[ ! -f bsnbot.env ]]; then
    ...
    echo "##vso[task.setvariable variable=_connectionString]Host=db;Port=5432;Username=postgres;Password=${POSTGRES_PASSWORD};Database=cryptodb;Pooling=true;Timeout=30;"
